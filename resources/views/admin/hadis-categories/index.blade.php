...
@section('title', 'Admin | Hadis Kategorileri')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4 class="card-title mb-0">Hadis Kategorileri</h4>
                        <a href="{{ route('admin.hadis-categories.create') }}" class="btn btn-primary">Yeni Kategori</a>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    @forelse ($hadisCategories as $hadisCategory)
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <a href="{{ route('admin.hadis-categories.edit', $hadisCategory) }}" class="btn btn-sm btn-outline-primary">Düzenle</a>
                                                <form action="{{ route('admin.hadis-categories.destroy', $hadisCategory) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
